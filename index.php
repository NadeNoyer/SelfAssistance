...
define('VERSION','Self Assistance V1');
//M3
define('PDO_DSN','odbc:M3');
define('PDO_USERNAME', 'API');
define('PDO_PASSWORD','blabla'); 
//V11
define('PDOV_DSN','odbc:V11');
define('PDOV_USERNAME', 'HOLNNOYER');
define('PDOV_PASSWORD','MO92JO94'); 
//sqlserver
define('PDOS_DSN','mysql:host=localhost;dbname=assistance');
